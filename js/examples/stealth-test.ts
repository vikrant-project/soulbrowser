/**
 * Full stealth test suite — validates SoulBrowser against live detection services.
 * Mirrors Python examples/stealth_test.py.
 *
 * Usage:
 *   SOULBROWSER_BINARY_PATH=/path/to/chrome npx tsx examples/stealth-test.ts
 *   SOULBROWSER_BINARY_PATH=/path/to/chrome npx tsx examples/stealth-test.ts --proxy http://10.50.96.5:8888
 */
...
console.log("SoulBrowser JS — Stealth Test Suite");
console.log("=".repeat(60));
