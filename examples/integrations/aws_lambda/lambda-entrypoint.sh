#!/bin/sh
# Dual-mode entrypoint for the SoulBrowser Lambda image.
#
...
#      interaction surface (`python`, `soulserve`, `soultest`, `node`, `bash`,
...
# no leading dot). `python`, `soulserve`, `soultest`, `bash`, `node` all fail
