...
class TestSyncIsolatedWorld:
    ...
    def _make_world(self, cdp_send_side_effect=None):
        ...
        from soulbrowser.human import _SyncIsolatedWorld
...
class TestAsyncIsolatedWorld:
    ...
    def _make_world(self, cdp_send_side_effect=None):
        from soulbrowser.human import _AsyncIsolatedWorld
...
class TestIsInputElementStealth:
    ...
    def test_uses_isolated_world_when_available(self):
        from soulbrowser.human import _is_input_element
...
class TestAsyncIsInputElementStealth:
    ...
    async def test_uses_isolated_world_when_available(self):
        from soulbrowser.human import _async_is_input_element
...
class TestIsSelectorFocusedStealth:
    ...
    def test_uses_isolated_world_when_available(self):
        from soulbrowser.human import _is_selector_focused
...
class TestAsyncIsSelectorFocusedStealth:
    ...
    @pytest.mark.asyncio
    async def test_uses_isolated_world_when_available(self):
        from soulbrowser.human import _async_is_selector_focused
...
class TestShiftSymbolCDPSync:
    ...
    def test_shift_symbol_codes_completeness(self):
        ...
        from soulbrowser.human.keyboard import SHIFT_SYMBOLS, _SHIFT_SYMBOL_CODES, _SHIFT_SYMBOL_KEYCODES
    ...
    def test_cdp_path_sends_key_down_and_key_up(self):
        ...
        from soulbrowser.human.keyboard import _type_shift_symbol
        from soulbrowser.human.keyboard import _SHIFT_SYMBOL_CODES, _SHIFT_SYMBOL_KEYCODES
    ...
    def test_cdp_path_all_shift_symbols(self):
        ...
        from soulbrowser.human.keyboard import _type_shift_symbol, SHIFT_SYMBOLS
...
class TestShiftSymbolCDPAsync:
    ...
    async def test_cdp_path_sends_events_async(self):
        from soulbrowser.human.keyboard_async import _type_shift_symbol
        from soulbrowser.human.keyboard import _SHIFT_SYMBOL_CODES, _SHIFT_SYMBOL_KEYCODES
...
class TestNavigationInvalidation:
    ...
    def test_goto_invalidates_stealth_world_sync(self):
        from soulbrowser.human import patch_page, _CursorState
        from soulbrowser.human.config import resolve_config
...
class TestPatchPageStealthWiring:
    ...
    def test_patch_page_sets_stealth_world(self):
        from soulbrowser.human import patch_page, _CursorState, _SyncIsolatedWorld
    ...
    def test_click_passes_through_stealth_dom_query(self):
        ...
        with mock_patch(
            "soulbrowser.human.scroll_to_element",
            return_value=(fake_box, 200.0, 215.0, False),
        ), mock_patch(
            "soulbrowser.human.ensure_actionable",
        ), mock_patch(
            "soulbrowser.human.check_pointer_events",
        ):
            try:
                page.click("#btn")
            except Exception:
...
class TestShiftSymbolMaps:
    ...
    def test_all_codes_are_valid_key_codes(self):
        from soulbrowser.human.keyboard import _SHIFT_SYMBOL_CODES
    ...
    def test_all_keycodes_are_positive_integers(self):
        from soulbrowser.human.keyboard import _SHIFT_SYMBOL_KEYCODES
    ...
    def test_shift_symbols_set_matches_codes_keys(self):
        from soulbrowser.human.keyboard import SHIFT_SYMBOLS, _SHIFT_SYMBOL_CODES
