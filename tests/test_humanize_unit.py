...
class TestConfigResolution:
    def test_default_config_resolves(self):
        from soulbrowser.human.config import resolve_config, HumanConfig
    ...
    def test_careful_config_resolves(self):
        from soulbrowser.human.config import resolve_config
    ...
    def test_rand_within_bounds(self):
        from soulbrowser.human.config import rand, rand_range
        for _ in range(200):
            v = rand(10, 20)
            assert 10 <= v <= 20
        for _ in range(200):
    ...
    def test_sleep_ms_timing(self):
        from soulbrowser.human.config import sleep_ms
        t0 = time.time()
        sleep_ms(50)
...
class TestBezierMath:
    def test_generates_multiple_points(self):
        from soulbrowser.human.mouse import human_move
        from soulbrowser.human.config import resolve_config
        cfg = resolve_config("default", None)
        raw = _FakeRawMouse()
    ...
    def test_click_target_within_box(self):
        from soulbrowser.human.mouse import click_target
        from soulbrowser.human.config import resolve_config
        cfg = resolve_config("default", None)
...
class TestAsyncCompat:
    def test_async_modules_import(self):
        from soulbrowser.human.mouse_async import AsyncRawMouse, async_human_move
        from soulbrowser.human.keyboard_async import AsyncRawKeyboard, async_human_type
        from soulbrowser.human.scroll_async import async_scroll_to_element
        from soulbrowser.human import patch_page_async, patch_browser_async, patch_context_async
    ...
    def test_async_sleep_is_coroutine(self):
        from soulbrowser.human.config import async_sleep_ms
        import asyncio
    ...
    def test_patch_page_async_does_not_crash(self):
        ...
        import soulbrowser.human as h
        from soulbrowser.human import _CursorState
        from soulbrowser.human.config import resolve_config
...
class TestFocusCheck:
    def test_press_skips_click_when_focused(self):
        ...
        with mock_patch("soulbrowser.human._is_selector_focused", return_value=True):
    ...
    def test_press_clicks_when_not_focused(self):
        ...
        with mock_patch("soulbrowser.human._is_selector_focused", return_value=False):
            from playwright.sync_api._generated import Locator
            loc = MagicMock()
            loc.page = page
            loc._impl_obj = MagicMock()
...
class TestCheckUncheckIdle:
    def test_check_calls_idle_when_enabled(self):
        ...
        with mock_patch("soulbrowser.human.human_idle", fake_idle):
            Locator.check(loc)
...
class TestFramePatching:
    def test_all_11_methods_patched(self):
        from soulbrowser.human import _patch_single_frame_sync, _CursorState
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock
...
class TestSelectAllPlatform:
    def test_select_all_constant_exists(self):
        from soulbrowser.human import _SELECT_ALL
...
class TestNonAsciiKeyboard:
    def test_cyrillic_uses_insert_text(self):
        from soulbrowser.human.keyboard import human_type
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock
...
class TestNonAsciiKeyboardAsync:
    ...
    async def test_async_cyrillic_uses_insert_text(self):
        from soulbrowser.human.keyboard_async import async_human_type
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock, AsyncMock
...
class TestElementHandlePatchingSync:
    ...
    def test_patch_single_element_handle_marks_patched(self):
        from soulbrowser.human import _patch_single_element_handle_sync, _CursorState
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock
    ...
    def test_page_query_selector_patched(self):
        from soulbrowser.human import _patch_page_element_handles_sync, _patch_single_element_handle_sync, _CursorState
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock
    ...
    def test_page_query_selector_all_patches_all(self):
        from soulbrowser.human import _patch_page_element_handles_sync, _CursorState
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock
...
class TestElementHandlePatchingAsync:
    ...
    async def test_async_element_handle_click(self):
        from soulbrowser.human import _patch_single_element_handle_async, _CursorState
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock, AsyncMock
    ...
    async def test_async_page_query_selector_patched(self):
        from soulbrowser.human import _patch_page_element_handles_async, _CursorState
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock, AsyncMock
...
class TestPerCallTimeoutForwarding:
    ...
    def test_get_element_box_default_timeout(self):
        ...
        from soulbrowser.human.scroll import _get_element_box
        from unittest.mock import MagicMock
    ...
    def test_scroll_to_element_forwards_timeout(self):
        ...
        from soulbrowser.human.scroll import scroll_to_element
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock
    ...
    def test_page_click_forwards_timeout_kwarg(self):
        ...
        soulbrowser.human module attribute used by patch_page.
        """
        import soulbrowser.human as h
        from soulbrowser.human import _CursorState
        from soulbrowser.human.config import resolve_config
...
class TestPerCallHumanConfigOverride:
    ...
    def test_merge_config_creates_new_instance(self):
        from soulbrowser.human.config import resolve_config, merge_config
...
class TestScrollIntoViewIfNeeded:
    ...
    def test_human_scroll_into_view_skips_when_in_viewport(self):
        ...
        from soulbrowser.human.scroll import human_scroll_into_view
        from soulbrowser.human.config import resolve_config
        from unittest.mock import MagicMock
