...
from soulbrowser.browser import build_args, _resolve_timezone
...
def test_override_logs_debug(caplog):
    ...
    with caplog.at_level(logging.DEBUG, logger="soulbrowser"):
...
def test_resolve_webrtc_args_auto():
    ...
    from soulbrowser.browser import _resolve_webrtc_args
    from unittest.mock import patch

    with patch("soulbrowser.geoip._resolve_exit_ip", return_value="5.6.7.8"):
