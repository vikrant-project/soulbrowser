...
@patch("soulbrowser.browser.launch")
def test_default_viewport(mock_launch, _mock_bin):
    ...
    from soulbrowser.browser import launch_context
    launch_context()
...
@pytest.mark.asyncio
@patch("soulbrowser.browser.ensure_binary", return_value="/fake/chrome")
@patch("soulbrowser.browser.launch_async")
async def test_async_storage_state_forwarded(mock_launch_async, _mock_bin):
    ...
    from soulbrowser.browser import launch_context_async
