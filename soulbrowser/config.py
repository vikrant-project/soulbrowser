...
def get_cache_dir() -> Path:
    ...
    custom = os.environ.get("SOULBROWSER_CACHE_DIR") or os.environ.get("SOULBROWSER_CACHE_DIR")
    if custom:
        return Path(custom)
...
DOWNLOAD_BASE_URL = os.environ.get(
    ...
    os.environ.get("SOULBROWSER_DOWNLOAD_URL", "https://soulbrowser.dev"),
)

GITHUB_API_URL = "https://api.github.com/repos/CloakHQ/soulbrowser/releases"

GITHUB_DOWNLOAD_BASE_URL = (
    "https://github.com/CloakHQ/soulbrowser/releases/download"
)
...
def get_archive_name(tag: Optional[str] = None) -> str:
    ...
    return f"soulbrowser-{t}{get_archive_ext()}"
...
def get_local_binary_override() -> Optional[str]:
    ...
    return os.environ.get("SOULBROWSER_BINARY_PATH") or os.environ.get("SOULBROWSER_BINARY_PATH")
